...
int main()
{
	...
	do
	{
		...
		scanf("%i", &n);
		if (n <= 0)
			printf("Debes ingresar un valor mayor o igual a 1\n");
	} while (n <= 0);
	...
	if (contenido == 0)
		printf("la cadena '%s' NO se encuentra dentro de la cadena principal.", subCadena);
	if (contenido == 1)
		printf("la cadena '%s' SI se encuentra dentro de la cadena principal.", subCadena);
